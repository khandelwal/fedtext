...
# OVERALL PIPELINE PLAN: Take page_body, which should be webpage body content
# PreProcess and Clean Data Split words by: SPACE, PUNCTUATION Filter out:
# STOP_WORDS, Make Frequency Count
#
# This could be done by a single processer but is implemented in / as multiple
# stages for simplicity / experimentation / maintainability
#
# Note see ../settings.py to ensure ITEM_PIPELINES matches ideal order
# Examples:
# http://doc.scrapy.org/en/latest/topics/item-pipeline.html#topics-item-pipeline
